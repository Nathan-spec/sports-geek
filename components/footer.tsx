        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link href="/collections/heritage" className="block text-gray-400 hover:text-white transition-colors">
                Heritage Collection
              </Link>
              <Link href="/collections/limited" className="block text-gray-400 hover:text-white transition-colors">
                Limited Editions
              </Link>
              <Link href="/gift-sets" className="block text-gray-400 hover:text-white transition-colors">
                Gift Sets
              </Link>
