        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image
                src="/assets/passion-heritage.png"
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    It all started in 2025 when our founder, Dickson Makachia, was watching Kenya's rugby sevens team
                  ...
                  <p>
                    Today, SportsGeekScarves has grown from that single vision to serve thousands of fans across 10+
